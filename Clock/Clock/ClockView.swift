...
class ClockView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if let context = UIGraphicsGetCurrentContext() {
            ...
            let largeDotRaius: CGFloat = 6.0
            let centerCircle = CGRect(x: clockCenter.x - largeDotRaius, y: clockCenter.y - largeDotRaius, width: 2 * largeDotRaius, height: 2 * largeDotRaius)
